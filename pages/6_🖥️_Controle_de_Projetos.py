...
def main() -> None:
    ...
    with left:
        ...
        table_cols = ["service_name","complemento","project_number","start_date","delivery_date","status","revision_code","observation"]
...
with st.expander("➕ Adicionar tarefa/documento", expanded=False):
    ...
    if st.button("Adicionar linha", width='stretch'):
        ...
        wanted = [c for c in ["id","service_name","doc_name","doc_number","revision_code","start_date","delivery_date","status"] if c in doc_edit_view.columns]
