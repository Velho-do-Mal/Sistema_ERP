...
def get_conn():
    ...
    """
    db_url = os.getenv("DATABASE_URL") or (st.secrets.get("general", {}) or {}).get("database_url")
    if not db_url:
        raise RuntimeError("DATABASE_URL não configurada. Defina a variável de ambiente ou o secrets.toml.")
